...
<button class="button-xlarge pure-button"onclick="location.href=''">קינוחים</button></br></br>
...
<div class="btn">
	...
	<input class="G_M_M"  type="button" onclick="location.href='sign.in.php'" value="מלצר/מנהל" /></br></br> 
	 

	<input class="G_M_M"  type="button" onclick="location.href='games.html';" value="משחקים" />
